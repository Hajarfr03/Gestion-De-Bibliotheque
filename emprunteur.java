...
public class emprunteur extends javax.swing.JFrame {
   private boolean clicked = false;
    ...
    private void initComponents() {
        ...
        tableau1.setBackground(new java.awt.Color(204, 204, 204));
        tableau1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "LastName", "FirstName", "Book", "FirstDate", "LastDate"
            }
        ));
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 380, -1, -1));
        ...
        jPanel1.add(Refrech, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 380, -1, -1));
    ...
    private void RefrechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefrechActionPerformed
        // TODO add your handling code here:
        if (!clicked) {
            DefaultTableModel model = (DefaultTableModel) tableau1.getModel();

            String driver="com.mysql.jdbc.Driver";
            String strcon= "jdbc:mysql://localhost:3306/utilisateur";
            String req= "select *  from emprunteur";
    ...
    private void supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_supprimerActionPerformed
        ...
        String driver="com.mysql.jdbc.Driver";
        String strcon= "jdbc:mysql://localhost:3306/utilisateur";
        String req= "delete from emprunteur where id=?";
        int selectedRow = tableau1.getSelectedRow();
