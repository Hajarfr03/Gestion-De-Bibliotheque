...
public class espaceutilisateur extends javax.swing.JFrame {
    SessionManager sessionManager = SessionManager.getInstance();
        ...
        int ID = (int) sessionManager.getAttribute("ID");
    ...
    private void initComponents() {
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SignUP/WhatsApp Image 2024-05-19 at 00.12.17.jpeg"))); // NOI18N
        jPanel11.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 30, 30, 30));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SignUP/WhatsApp Image 2024-05-19 at 00.11.53.jpeg"))); // NOI18N
        jPanel11.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 30, 30, 30));
        ...
        search.setFont(new java.awt.Font("Brush Script MT", 0, 18)); // NOI18N
        search.setForeground(new java.awt.Color(204, 204, 204));
        search.setText("Search With Title");
        search.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                searchMouseEntered(evt);
            }
        });
        jPanel11.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 30, 170, 30));
...
String driver = "com.mysql.jdbc.Driver";
String strCon = "jdbc:mysql://localhost:3306/utilisateur";
String req = "SELECT * FROM book where Title=?";
